            ...
            {producer.consolidaciones?.length > 0 ? (
              <div style={{ display:"flex", flexDirection:"column", gap:"8px", marginBottom:"14px" }}>
                {producer.consolidaciones.map((c: any, i: number) => (
                  <div key={i} onClick={() => c.status==="open" && onJoin?.(c)} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", padding:"10px 12px", background:"rgba(255,255,255,0.03)", borderRadius:"8px", border:`0.5px solid ${c.status==="open"?"rgba(74,222,128,0.1)":"rgba(251,146,60,0.1)"}`, cursor: c.status==="open" ? "pointer" : "default", opacity: c.status==="open" ? 1 : 0.5 }}>
        ...
        <div style={{ position:"fixed", inset:0, background:"rgba(0,0,0,0.75)", zIndex:500, display:"flex", alignItems:"center", justifyContent:"center", padding:"20px" }}>
          <div style={{ background:"#071a0e", border:"0.5px solid rgba(74,222,128,0.2)", borderRadius:"16px", width:"100%", maxWidth:"500px", maxHeight:"90vh", overflowY:"auto" }}>
            ...
            <div style={{ padding:"4px 28px 0", display:"flex", justifyContent:"space-between" }}>
              {[t("Your info","Tus datos"), t("Signature","Firma"), t("Done","Listo")].map((l,i) => (
